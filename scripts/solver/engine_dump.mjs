...
// A/B toggle for the distilled policy (default on) so the harness can measure it.
if (process.env.DISABLE_DISTILL === "1") globalThis.__ENABLE_DISTILL__ = false;
else if (process.env.ENABLE_DISTILL === "1") globalThis.__ENABLE_DISTILL__ = true;
